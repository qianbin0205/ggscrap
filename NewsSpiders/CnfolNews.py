...
class CnfolNewsSpider(GGNewsSpider):
    ...
    lps = [
        ...
        },
        {
            ...
            'pg': 1,
            'url': lambda
                pg: "http://app.cnfol.com/qualityarticles/qualityarticles.php?CatId=133&starttime=1514509821&endtime=1514524221&num=30&page="
        ...
        },
        {
            ...
            'pg': 1,
            'url': lambda
                pg: "http://app.cnfol.com/dataapi/index.php/hotlable/selectArticle?keywords=%E5%90%8D%E5%AE%B6%E6%9C%BA%E6%9E%84&page="
