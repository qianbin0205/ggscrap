...
class SczqSpider(GGFundNavSpider):
    ...
    start_urls = ['http://assets.sczq.com.cn/servlet/scproduct/AssetmanagmentAction?function=ProductNav&type=1&fundcode=E99']
    ...
    def parse_fund(self, response):
        ...
        funds = response.xpath('//table/tr')[1:-2]
        for fund in funds:
            fundcode = fund.xpath("./td/a/@href").re_first(r'fundcode=(\S+)')
            ips.append({
                'pg': 1,
                'url': lambda pg:'http://assets.sczq.com.cn/servlet/scproduct/AssetmanagmentAction?function=ProductNav&fundcode=' + fundcode + '&startdate=&enddate=&curPage='+
                    str(pg)+'&catalogNo=&reqUrl=%2Fservlet%2Fscproduct%2FAssetmanagmentAction%3Ffunction%3DProductNav',
                'ref': 'http://assets.sczq.com.cn/servlet/scproduct/AssetmanagmentAction?function=ProductNav&type=1&fundcode='+fundcode,
