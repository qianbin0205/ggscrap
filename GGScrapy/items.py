...
class GGIrcsItem(scrapy.Item):
    ...
    url = scrapy.Field()                            # 链接地址
    asker = scrapy.Field()                          # 提问人员
    stk_code = scrapy.Field()                       # 股票代码
    stk_name = scrapy.Field()                       # 股票名称
    ask_time = scrapy.Field()                       # 提问时间
    ask_content = scrapy.Field()                    # 提问内容
    reply_time = scrapy.Field()                     # 回答时间
    reply_content = scrapy.Field()                  # 回答内容
